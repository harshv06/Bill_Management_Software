...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Only fetch data if user is SUPER_ADMIN
    ...
    if (user?.role === "SUPER_ADMIN") {
      const fetchDashboardData = async () => {
        try {
          ...
          setDashboardData({
            monthly_expenses:
              data.monthly_expenses || Array(12).fill({ total_expense: 0 }),
            monthly_revenues:
              data.monthly_revenues || Array(12).fill({ total_revenue: 0 }),
